# Cloudflare Tunnel app repository

This repository contains the apps supporting the secure exposure of Home Assistant and
related services through Cloudflare Tunnel (formerly Argo Tunnel).

<!--
App documentation: <https://developers.home-assistant.io/docs/add-ons>
-->
...
## [Cloudflare Tunnel app](./cloudflared/README.md)
...
Notes to developers after forking or using the github template feature:
  - While developing comment out the 'image' key from 'cloudflared/config.yaml' to make the supervisor build the app
